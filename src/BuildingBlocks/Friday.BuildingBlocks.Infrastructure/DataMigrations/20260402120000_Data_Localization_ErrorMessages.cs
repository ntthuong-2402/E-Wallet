...
[FridayDataMigration(
    ...
    "Data: localization.error_messages — upsert default rows by (Module, ErrorCode, Language)."
)]
public sealed class Data_20260402120000_Localization_ErrorMessages : AutoReversingMigration
{
